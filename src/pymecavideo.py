...
#        Error._ = self.tr
        ...
        #expérimental : intègre le lecteur vidéo
        video="/usr/share/python-mecavideo/video/g1.avi"
        fifo=os.path.join(APP_DATA_PATH, "fifo")
        conteneurVideo=cadreur.OpenCvContainer(self, video, fifo)
        lostFrame=self.ui.frameVideo
        self.ui.frameVideo=conteneurVideo
        del lostFrame
